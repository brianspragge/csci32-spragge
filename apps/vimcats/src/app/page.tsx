...
export default function Home() {
  return (
    <>
      ...
      <Page>
        <Image className="h-20 w-auto" src="/Vimlogo.svg.webp" alt="Vim logo" width={80} height={80} priority />
        <div className="flex flex-col items-center gap-6 text-center">
          <h1 className="max-w-xs text-3xl font-semibold leading-10 tracking-tight text-black dark:text-black">
            ...
            <code className="rounded bg-black/6 px-1.5 py-0.5 font-mono text-[0.9em] dark:bg-white/8">cats.vimrc</code>{' '}
            file.
          </h1>
